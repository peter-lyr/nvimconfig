...
vim.api.nvim_create_user_command('DiffvieW', function(params)
  M.run(params['fargs'])
end, { nargs = "*", })

-- mappings

vim.keymap.set({ 'n', 'v' }, '<leader>gi', ':<c-u>DiffvieW filehistory<cr>',  { silent = true })
vim.keymap.set({ 'n', 'v' }, '<leader>go', ':<c-u>DiffvieW open<cr>',  { silent = true })
vim.keymap.set({ 'n', 'v' }, '<leader>gq', ':<c-u>DiffvieW quit<cr>',  { silent = true })

vim.keymap.set({ 'n', 'v' }, '<leader>gT', ':<c-u>DiffvieW toggle_history_cnt<cr>',  { silent = true })
vim.keymap.set({ 'n', 'v' }, '<leader>ge', ':<c-u>DiffvieW DiffviewRefresh<cr>',  { silent = true })
vim.keymap.set({ 'n', 'v' }, '<leader>gl', ':<c-u>DiffvieW DiffviewToggleFiles<cr>',  { silent = true })
